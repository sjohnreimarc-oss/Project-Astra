...
class OrbitalMechanicsGUI:
    ...
    def show_orbital_mechanics_frame(self):
        ...
        self.inputs_frame = ctk.CTkFrame(self.app.content_frame,
                                         corner_radius=15, border_width=1, border_color="#2A2A2A", fg_color="#1C1C1C")
        self.results_frame = ctk.CTkFrame(self.app.content_frame,
                                          corner_radius=15, border_width=1, border_color="#2A2A2A", fg_color="#1C1C1C")
    ...
    def build_orbital_input_frame(self):
        ...
        self.orbital_clear_button = ctk.CTkButton(
            self.orbital_calculate_frame, text="  CLEAR", image=self.ui_icons.get("trash"), compound="left", height=50,
    ...
    def build_orbital_results_frame(self):
        ...
        self.main_results_frame = ctk.CTkFrame(self.results_frame, fg_color="transparent", height=120, width=900,
                                               corner_radius=20)
        ...
        self.result_calculation_label = ctk.CTkLabel(self.main_results_frame, text="",
        ...
        self.main_result = ctk.CTkLabel(self.main_results_frame, text="Awaiting Calculation...",
                                        font=ctk.CTkFont(size=30), text_color="#1a8cf0")
        self.main_result.grid(row=1, column=0, padx=10, pady=10)

        self.secondary_result = ctk.CTkLabel(self.main_results_frame, text="", font=ctk.CTkFont(size=16),
                                             text_color="#505a63")
        ...
        additional_info_frame = ctk.CTkFrame(self.results_frame, fg_color="transparent", height=190, width=600,
                                             corner_radius=20)
